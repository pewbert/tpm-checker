...
$x = Get-CimInstance -Namespace 'root/cimv2/Security/MicrosoftTpm' -ClassName 'Win32_TPM' | Invoke-CimMethod -MethodName 'GetPhysicalPresenceConfirmationStatus' -Arguments @{Operation=$rval.Request}
...
Function setPPR() #DO NOT USE -- BREAKS TPM and more
{
    $forceValue="0" #0 to 22 -- see GetPhysicalPresenceRequest row1 values
    Get-CimInstance -Namespace 'root/cimv2/Security/MicrosoftTpm' -ClassName 'Win32_TPM' | Invoke-CimMethod -MethodName 'SetPhysicalPresenceRequest' -Arguments @{Request='$forceValue'}
    Get-CimInstance -Namespace 'root/cimv2/Security/MicrosoftTpm' -ClassName 'Win32_TPM' | Invoke-CimMethod -MethodName 'GetPhysicalPresenceConfirmationStatus' -Arguments @{Operation=$rval.Request}
